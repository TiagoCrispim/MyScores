...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final int REQUEST_API_LOGIN = 5;
    ...
    //Inicia a funcação login na singletonUsers que vai buscar os dados de utilizador
    private void attemptLogin() {

        showProgress(true);

        String usernameInput = mUsernameView.getText().toString();
        String passwordInput = mPasswordView.getText().toString();

        SingletonUsers.getInstance(getApplicationContext()).loginAPI(usernameInput, passwordInput, getApplicationContext());
    ...
    private void loginStart(){
        String dados = SingletonUsers.getInstance(this).returnDadosLogin();
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // Show primary username first. Note that there won't be
